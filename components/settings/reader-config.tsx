...
export function ReaderConfig({ className }: Props) {
    ...
    const isScrollableMode = readingMode === "continuous-vertical" || readingMode === "continuous-horizontal";
        ...
        <div className={cn("flex flex-col gap-10", className)}>
            ...
            <div className="flex flex-col gap-4">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-2">
                    {[
                        { id: "single-page", label: "Single", icon: Smartphone },
                        { id: "double-page", label: "Double", icon: AppWindow },
                        { id: "continuous-vertical", label: "Vertical", icon: Rows },
                        { id: "continuous-horizontal", label: "Horizontal", icon: Columns },
                    ...
                    {[
                        ...
                        <button 
                            ...
                            className={cn(
                                ...
                                hudType === type.id ? "bg-primary/20 border-primary text-primary" : "bg-muted/10 border-border/40 text-muted-foreground hover:bg-muted/20"
                            )}
                        >
            ...
            <div className="flex flex-col gap-4">
                ...
                <div className="grid grid-cols-2 gap-2">
                    {[
                        ...
                        <button 
                            key={orient.id}
                            onClick={() => setHudOrientation(orient.id as HudOrientation)}
                            className={cn(
                                "flex items-center justify-center gap-3 p-3 rounded-xl border transition-all cursor-pointer",
                                hudOrientation === orient.id ? "bg-primary/20 border-primary text-primary" : "bg-muted/10 border-border/40 text-muted-foreground hover:bg-muted/20"
                            )}
                        >
                            <orient.icon className="size-4" />
                            <span className="text-xs font-bold">{orient.label}</span>
                        </button>
                    ))}
                </div>
            </div>
                ...
                <div className="flex flex-col gap-4">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                        {[
                            ...
                            <button 
                                key={dir.id}
                                onClick={() => setReadingDirection(dir.id as ReadingDirection)}
                                className={cn(
                                    "flex items-center justify-center gap-3 p-3 rounded-xl border transition-all cursor-pointer",
                                    readingDirection === dir.id ? "bg-primary/20 border-primary text-primary" : "bg-muted/10 border-border/40 text-muted-foreground hover:bg-muted/20"
                                )}
                            >
            ...
            <div className="flex flex-col gap-4">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
                    {["edge", "kindle", "l-shape", "right-left", "disabled"].map((zone) => (
                        <button 
                            key={zone}
                            ...
                            className={cn(
                                ...
                                tapZone === zone ? "bg-primary/20 border-primary text-primary" : "bg-muted/10 border-border/40 text-muted-foreground hover:bg-muted/20"
                            )}
                        >
                            {zone.replace("-", " ")}
                        </button>
            ...
            <div className="flex flex-col gap-4">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                    {["none", "horizontal", "vertical", "both"].map((invert) => (
                        <button 
                            key={invert}
                            onClick={() => setInvertTapZone(invert as InvertTapZone)}
                            className={cn(
                                "flex items-center justify-center p-2 rounded-xl border transition-all cursor-pointer text-[10px] font-bold capitalize",
                                invertTapZone === invert ? "bg-primary/20 border-primary text-primary" : "bg-muted/10 border-border/40 text-muted-foreground hover:bg-muted/20"
                            )}
                        >
                            {invert}
                        </button>
            ...
            <div className="flex flex-col gap-4">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                    {[
                        { id: "fit-width", label: "Width", icon: MoveHorizontal },
                        { id: "fit-height", label: "Height", icon: MoveVertical },
            ...
            {isScrollableMode && (
                <div className="flex flex-col gap-4">
                    <div className="flex items-center justify-between">
                        ...
                        <span className="text-xs font-mono text-primary font-bold">{pageGap}px</span>
                    </div>
                    <input 
                        type="range" 
                        min="0" 
                ...
                <div className="flex gap-2">
                    <button 
                        ...
                        className={cn(
                            ...
                            background === "black" ? "border-primary bg-primary/10" : "border-border/40 bg-muted/10"
                        )}
                    >
                    ...
                    <button 
                        ...
                        className={cn(
                            "flex-1 p-3 rounded-xl border flex items-center justify-center gap-2 transition-all cursor-pointer", 
                            background === "zinc" ? "border-primary bg-primary/10" : "border-border/40 bg-muted/10"
                        )}
                    >
