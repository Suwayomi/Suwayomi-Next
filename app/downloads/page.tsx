            ...
            actions={
                <div className="flex items-center gap-2">
                    ...
                    <Button
                        ...
                        size="sm"
                        className={cn(
                            "rounded-full gap-2 font-bold shadow-lg",
                                    ...
                                    <div className="flex-1 min-w-0 space-y-2">
                                        <div className="flex items-center justify-between gap-4">
                                            <div className="min-w-0">
                                                <h4 className="font-bold text-foreground line-clamp-1 truncate">
                                                    {item.manga.title}
                                                </h4>
...
function Badge({ state }: { state: string }) {
    ...
    return (
        <div
            className={cn(
                "flex items-center gap-1.5 px-2 py-0.5 rounded-md border border-current/10 text-[10px] font-black uppercase tracking-tighter",
                config.color,
            )}
        >
