    ...
    return (
        ...
        >
            ...
            >
                ...
                {/* Actions Layer */}
                {manga.inLibrary
                    ? /* Dropdown Action Menu (Only renders if NOT in selection mode AND at least one callback is provided) */
                      !isSelectionMode &&
                      hasDropdownActions && (
                          <div className="absolute top-2 right-2 z-20 flex flex-col gap-2 opacity-100 transition-opacity group-hover:opacity-100 md:opacity-0">
                              <DropdownMenu>
                                  ...
                                  >
                                      ...
                                      {onMarkRead && <DropdownMenuSeparator />}
                    ...
                    : /* Hover Add Button (Only renders if the onAddLibrary callback is supplied) */
                      onAddLibrary && (
                          <div className="absolute inset-0 z-20 flex items-end bg-gradient-to-t from-black/80 via-transparent to-transparent p-5 opacity-0 transition-opacity group-hover:opacity-100">
                              <Button
                                  size="sm"
